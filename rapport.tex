...
\label{fig1}
\end{center}
Après une régression affine, nous avons comme pente: $-0.16344$. \\
Ainsi on estime graphiquement $p_{g_1} = e^{-0.16344} = 0.84922$.
\vspace{3mm}
...
Nous traçons les points suivants: $\left({x_i^\#} ; x_i^\# \dsp \frac{P(x_i^\#)}{P(x_{i}^\# + 1)} \right)$ \\
...
Intéressons nous à la probabilité que ce
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
