...
Nous traçons les point suivants: $\left({x_i^\#} ; x_i^\# \dsp \frac{P(x_i^\#)}{P(x_{i+1}^\#)} \right)$ \\
...
>>>>>>> 680dbc99aeeb7a7bb2702b4aaa5de8a6c5b0ff78
\vspace{3mm}
...
\captionof{figure}{Titre}
\label{fig1}
\end{center}
\end{enumerate}

D'après la question 1.3, on obtient une droite dont le coefficient directeur a est $a = ln(1-p) \Rightarrow p = 1 - e^{a} $ ce qui donne numériquement $ p=0,1507846 $\\
D'après la question 2.2, $ IC = [0.1354829, 0.1723137]$
